...
// import App from '@/components/Library/boxes/app/App';
...
//         <TextContainer>
//           <Text size="D1" weight="SEMIBLOB" color="primary_text">Choose apps you'd like to add</Text>
//           <Text size="H3" weight="NORMAL" color="primary_text">Give your site more functionality with Mocart business solutions.</Text>
//         </TextContainer>
//       </ContentWrapper>
//       <div>
//         <Text size="H3" weight="SEMIBLOB" color="primary_text">Recommended for you:</Text>
//         <ItemsContainer>
//           {data.map((item, index) => (
//             <App
//               key={index}
