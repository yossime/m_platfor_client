...
export const DisplayList: React.FC = () => {
    const [activeDisplay, setActiveDisplay] = useState<{ index: number; display: ISceneObject } | null>(null);
    const { sceneModel } = useEditor();
    const ref = useRef<HTMLDivElement>(null);
    ...
    //     const newDisplay = selectedObject.createChild(); // Assuming there's a method to create a new child
