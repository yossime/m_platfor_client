...
import { BoardType, FormatBoard } from "@/components/editor/types";
import { formatIcons, formats } from "../../types";
...
export const ChooseBoardFormat: React.FC<ChooseBoardWidgetComponentProps> = ({
  ...
  const formatSvg = formatIcons[FormatBoard.Duo];
...
{formatIcons[format] && React.createElement(formatIcons[format])}
            </FormatButton>
